...
class DialogShowNote {
    class DialogShowNote : DialogFragment() {
        ...
        override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
            ...
            val dialogView =
                    inflater.inflate(R.layout.dialog_show_note
                            , null)
            val txtTitle =
            ...
            val txtDescription =
                    ...
                    dialogView.findViewById(R.id.txtDescriptio
                            n) as TextView
            txtTitle.text = note!!.title
            txtDescription.text = note!!.description
            val txtImportant =

                    dialogView.findViewById(R.id.textViewImpor
                            tant) as TextView
            val txtTodo =
            ...
            val btnOK =
                    dialogView.findViewById(R.id.btnOK) as Buttonbuilder.setView(dialogView).setMessage("Your Note")
